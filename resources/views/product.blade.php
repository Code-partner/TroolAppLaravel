        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="product-pic-zoom">
                    <img class="product-big-img" src="{{$product->product_img}}" alt="">
                </div>
                <div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
                    <div class="product-thumbs-track">
                        <div class="pt active" data-imgbigurl="{{$product->product_img}}"><img src="{{$product->product_img}}" height="111px" alt=""></div>
                        <div class="pt" data-imgbigurl="{{$product->back_img}}"><img src="{{$product->back_img}}" height="111px" alt=""></div>
            ...
            <div class="col-lg-6 product-details">
                ...
                <h4 class="p-stock" id="p-stock">{{$product->skus()->first()->inventory->status}}</h4>
                <div class="p-rating">
                ...
                <div class="fw-size-choose">
                    ...
                    <div class="sc-item">
                        <input type="radio" value="{{$size->id}}" name="sc" id="{{$size->name}}-size">
                ...
                <div class="fw-size-choose">
                    <p>Color : {{$product->colors->first()->name}}</p>
                </div>
                @endif
                <div class="quantity">
                    <p>Quantity</p>
